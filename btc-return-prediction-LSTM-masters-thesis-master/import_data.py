...
if not isfile("C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Market/btc_logreturns_no_outliers.csv"):
    print("Generating logreturn csv.")
    generate_logreturns_csv()
btc_logreturn = pd.read_csv(
    "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Market/btc_logreturns_no_outliers.csv",
    index_col=0,
    parse_dates=True,
...
btc_volume = read_csv_bitcoinity(
    "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Market/bitcoinity_data_btc_price_usd_aggregate.csv"
)
...
sentiments = pd.read_csv(
    "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Sentiments/sentiments.csv", parse_dates=True, index_col=0
)
sentiments = sentiments.fillna(0)
# handle NA?

sentiments_sd = pd.read_csv(
    "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Sentiments/sentiments_sd.csv", parse_dates=True, index_col=0
)
sentiments_sd = sentiments_sd.fillna(0)
blockchain_blocksize = read_csv_bitcoinity(
    "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Blockchain/bitcoinity_data_btc_dailyaverageblocksize.csv"
)
...
blockchain_transactions = read_csv_bitcoinity(
    "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Blockchain/bitcoinity_data_btc_dailytransactionsonnetwork.csv"
)
...
blockchain_difficulty = read_csv_bitcoinity(
    "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Blockchain/bitcoinity_data_btc_miningdifficulty.csv"
)
...
blockchain_hashrate = read_csv_blockchaincom(
    "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Blockchain/blockchaincom_btc_hashrate.csv"
)
