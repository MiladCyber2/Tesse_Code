...
def generate_logreturns_csv():
    ...
    f_name = "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Market/bitcoinity_data_btc_price_usd_all_exchanges.csv"
    ...
    df_logreturns.to_csv("C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Data/Market/btc_logreturns_no_outliers.csv")
    return
...
def model_stats(model_name: str, pred_test, x_test, y_test, model, epoch_count):
    try:
        with open(
            os.path.normpath(os.path.join(os.getcwd(), "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/model_stats/modelstats.json")),
            "r",
        ) as f:
    ...
    with open(
        os.path.normpath(os.path.join(os.getcwd(), "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/model_stats/modelstats.json")), "w+"
    ) as f:
...
def train_model(
    ...
    model.save("C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/saved_models/modelbuilder_model.h5")
    return model
...
def clear_tmp_saved_models(folder_path: str):
    ...
    for f in files:
        assert ("model." in f) and (".keras" in f)
        try:
            os.remove(f)
...
def save_loss_history(num_epochs, train_loss, val_loss, name):
    ...
    df.to_csv(f"C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/model_stats/loss_history_{name}.csv")
    return
...
def main_plot(
    ...
    if plt_style == "complex":
        ...
        ax["Large"].set_zlabel("Z: Epoch")
    fig.tight_layout()
    fig.savefig("C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-LSTM-masters-thesis-master/Plots/main_plot_last.pdf")
    plt.show()
    return
