...
def model_stats(model_name: str, pred_test, x_test, y_test, model, epoch_count):
    ...
    try:
        with open(
            os.path.normpath(os.path.join(os.getcwd(), "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-CNN-masters-thesis-master/Model/modelstats.json")),
            "r",
        ) as f:
    ...
    with open(
        os.path.normpath(os.path.join(os.getcwd(), "C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-CNN-masters-thesis-master/Model/modelstats.json")), "w+"
    ) as f:
...
def save_loss_history(num_epochs, train_loss, val_loss, name):
    ...
    df.to_csv(f"C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-CNN-masters-thesis-master/model_stats/loss_history_{name}.csv")
    return
...
def main_plot(
    ...
    fig.tight_layout()
    fig.savefig("C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-CNN-masters-thesis-master/Plots/main_plot_last.pdf")
    plt.show()
    return
...
def pred_plot(
    ...
    fig.tight_layout()
    fig.savefig("C:/Users/Syber/Desktop/VS_code/code/btc-return-prediction-CNN-masters-thesis-master/Plots/main_plot_prediction.pdf")
    plt.show()
    return
